...
- 🎓 Currently pursuing **B.Tech in Computer Science Engineering (2nd Year)** at **Sage University Indore**
- 🐍 Focused on **Python** — backend development, automation, and problem solving
- 🌱 Currently strengthening my fundamentals in **Data Structures & Algorithms** and exploring **Python for backend development**
- 💼 Looking for **Software Engineering internships/new-grad roles**
